    ...
    <div class="login-submit round-corner" ref="slide">
        <form>
            <div class="left-login vertical-center" v-show="this.sw">
                <h1>login</h1>
                <div class="count">
                    <input type="text" placeholder="用户名/邮箱" class="init-input untize-input underline">
                </div>
                <div>
            ...
            <div class="right-signup vertical-center" v-show="!this.sw">
                ...
                <input type="submit" value="注册" class="init-input untize-input login-button round-corner">
            </div>
        </form>
    </div>
</template>
